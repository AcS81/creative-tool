...
const userPrompt = [
  ...
  "- languageTexture: analogyExampleDefinitionRatio (counts proportions), sentenceCompressionRatio (words per idea + distribution/timeline), humorTimingScore (items with setupStart/punchStart/deltaSeconds/landed), referenceDensityPerMin (counts by type), questionRate (counts for rhetorical vs genuine, timeline optional), audienceAddressFrequency (counts per minute with direct vs rhetorical breakdown and optional timeline).",
