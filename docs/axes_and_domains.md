# Axes & Domains – How to Read CreatorSight Scores

This is a quick, human-readable glossary for the axes shown in the Overview radar and domain tabs. Scores are approximate (0–100) and comparative; “unobserved” means the model could not confidently see/hear that signal.

## Meta axes (Overview radar)
- **Voice intensity** – energetic vs calm delivery; derived from pace, loudness range, and prosody.
- **Conceptual depth** – abstract/idea-heavy vs concrete/examples-heavy language.
- **Narrative structure strength** – clarity of hooks, setups, escalations, payoffs, and guided transitions.
